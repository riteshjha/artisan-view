...
### Form Generation for a model

Generate bootstrp form with laravel validation holder for a model fields

```bash
$ php artisan make:view account/create --extends=ayouts.home --section=pageTitle --section=breadCrumb --section="form:App\User"
```
